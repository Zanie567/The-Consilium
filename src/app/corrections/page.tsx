      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="mb-12 pb-8 border-b border-[var(--border)]">
          ...
          <p className="text-[var(--fg-muted)] text-lg leading-relaxed">
            The Consilium holds itself to the same standards of accuracy that we demand of the ideas we scrutinise.
            When we get something wrong, we say so — clearly, promptly, and without qualification.
          </p>
        </div>
        ...
        <div className="prose-consilium space-y-10">
          ...
          <section>
            ...
            <p>
              Every article published in The Consilium is reviewed by an editor before publication. We check
              facts, verify figures, and confirm the integrity of arguments. Despite these efforts, errors
              occasionally occur — in statistics, in the spelling of names, in the attribution of quotes, or
              in matters of interpretation. When they do, we correct them.
            </p>
            <p>
              Corrections are not embarrassments to be buried. They are a mark of editorial integrity. A
              publication that acknowledges its mistakes openly is more trustworthy than one that silently
              revises its copy or lets errors stand unchallenged. We are committed to the former.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              We distinguish corrections from updates. A <strong>correction</strong> acknowledges that
              something we published was wrong at the time of publication. An <strong>update</strong> reflects
              information that has changed since publication — for example, a policy that has since been
              amended, or a situation that has developed further. Both are labelled clearly on the article.
            </p>
          </section>
          ...
          <section>
            ...
            <div className="not-prose my-6 space-y-4">
              ...
              <div className="border border-[var(--border)] bg-[var(--bg-elevated)] p-5">
                ...
                <p className="text-[var(--fg-muted)] text-sm mb-2">
                  Use the subject line &ldquo;Correction Request&rdquo; and include the article title.
                </p>
          ...
          <section>
            <h2>Our process</h2>
            <p>
              We aim to acknowledge all correction requests within <strong>48 hours</strong> of receipt and
              to resolve them within <strong>five working days</strong>. Where a claim requires additional
              research or verification, we will advise you of the expected timeline.
            </p>
            <p>
            ...
            <ul>
              <li>
                A correction notice is added to the top of the article, alerting readers that the piece has
                been updated
              </li>
              <li>
            ...
            <p>
              We do not remove articles from the record except in exceptional circumstances — for example,
              where continued publication would cause harm or where an article has been found to be
              substantially fabricated. In such cases, we publish a note explaining why the article has
              been removed.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              We appreciate all correction requests, even those that turn out not to require a change.
              We will always explain our reasoning if we decide that a correction is not warranted. Factual
              disputes are different from differences of interpretation or opinion: we will not issue a
              correction simply because a reader disagrees with an author{"'"}s analysis or conclusions.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              For all editorial enquiries — including corrections, complaints, and feedback — please contact
              us at{' '}
